      ...
      <div className="search-workspace">
        <aside className="filter-rail" aria-label="Movie filters">
          ...
          <label className="control-field">
            <span>Genre</span>
            <input value={genre} onChange={(event) => setGenre(event.target.value)} placeholder="Example: Drama" />
          </label>

          <label className="control-field">
            <span>Language</span>
            <input value={language} onChange={(event) => setLanguage(event.target.value)} placeholder="Example: en / zh" />
          </label>
