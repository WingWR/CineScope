...
% 仅保留中文封面与中文摘要，去除英文封面与英文摘要
\makeatletter
\renewcommand{\tongji@makeabstract}{%
  \clearpage
  \tongji@chapter*[]{\tongji@cabstractname}[\rmfamily\xparameter@heading@cother{\tongji@cabstractname}]
  \pagenumbering{Roman}
  \tongji@cabstract
  \vskip12bp
  \setbox0=\hbox{{\bfseries\heiti\tongji@ckeyword@title}}
...
%%% 封面部分
\frontmatter
\tongjiinputfile{data/cover} \makecover                 % 封面, 位置: data/cover.tex
...
\tongjiinputfile{data/chap05}                           % 第五章, 位置: data/chap05.tex
